    ...
    ?>
      ...
      <div class="clothes_main section ">
          <div class="container-fluid jumbotron bg-warning">
            <h1 align="center" style="color: white;">Detail Produk</h1>
            <div class="row">
            ...
            <div class="detail_produk">
                <div class="form-group">
                  <label for="merk"><b style="color: white;">Merk : </b></label><br>
                        <input type="text" name="merk" placeholder="Merk" value="<?php echo $produk->merk;?>">
                  </div>
                  
                  <div class="form-group">
                        <label for="stok"><b style="color: white;">Stok :</b></label><br>
                        <input type="text" name="stok_produk" value="<?php echo $produk->stok_produk;?>">
                  </div>
                  ...
                  <div class="form-group">
                        <label for="jumlah_beli"><b style="color: white;">jumlah beli :</b></label><br>
                        <input type="number" name="jml_beli" placeholder="Masukkan jumlah pembelian" maxlength="2" required>
                  </div>

                  <a href="<?php echo site_url('store/Store_keranjang');?>" class="btn btn-dark">Pesan</a>
