   ...
   <body class="main-layout">
      ...
      <div class="clothes_main section ">
          <div class="container-fluid jumbotron bg-warning">
            <div class="row">
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12"s>
                  ...
                  <div class="row">
                        ...
                        <div class="sport_product">
                              ...
                              <h4><?php echo $produk->nm_produk; ?></h4>
                                    <p align="center" style="font-style: 20px; color: black;"><b>Jumlah pesan : 1</p>
                              </td>
                </table>
                  

                  <a href="<?php echo site_url('store/Store_bayar/')?>" class="btn btn-dark">Bayar</a>
